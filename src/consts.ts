...
export const CATEGORY_COLORS: Record<Category, { fg: string; bg: string }> = {
  写真: { fg: '#fbbf24', bg: 'rgba(251,191,36,0.12)' },
  旅行: { fg: '#34d399', bg: 'rgba(52,211,153,0.12)' },
  競馬: { fg: '#a78bfa', bg: 'rgba(139,92,246,0.12)' },
  技術: { fg: '#38bdf8', bg: 'rgba(56,189,248,0.12)' },
  ガジェット: { fg: '#fb923c', bg: 'rgba(251,146,60,0.12)' },
  その他: { fg: '#94a3b8', bg: 'rgba(148,163,184,0.12)' },
};
